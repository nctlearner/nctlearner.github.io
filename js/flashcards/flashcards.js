...
$(document).ready(function() {
  ...
  console.log("loading my flashcards");
    var myFlashcards = [
      {question: '<img src="https://vignette.wikia.nocookie.net/smtown/images/5/51/Johnny_nct_2018_empathy_photo.JPG/revision/latest?cb=20180314114444" />',
      answer: 'Johnny'},
      {question: '<img src="https://data.whicdn.com/images/313737262/large.jpg" />',
      answer: 'Haechan'}
     ];
