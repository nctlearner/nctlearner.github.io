;(function(exports) {
  function loadFromArray(array) {
    ...
    ouicards.flashcards =[
  {question: 'https://vignette.wikia.nocookie.net/smtown/images/5/51/Johnny_nct_2018_empathy_photo.JPG/revision/latest?cb=20180314114444',
  answer: 'Johnny'},
  {question: 'https://data.whicdn.com/images/313737262/large.jpg',
  answer: 'Haechan'}
 ];
    resetBuckets();
  }
  ...
  function buildQuestionHTML(rawQuestion) {
    ...
    questionEl.innerHTML = '<img style="width: 480px; height: auto" src="' + rawQuestion.question + '" />';
